...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		//isSafari = $.browser.webkit || $.browser.safari ? true : false; //changed for Chrome issue
...
$.jgrid.extend({
    ...
    columnChooser : function(opts) {
        ...
        var selector = $('<div id="colchooser_'+self[0].p.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple" disabled="disabled"></select></div></div>');
