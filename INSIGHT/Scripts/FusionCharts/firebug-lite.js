...
},monitor:function(fn,script,monitored){if(monitored){Firebug..unmonitorScript(fn,script,"monitor")
}else{Firebug..monitorScript(fn,script,"monitor")
...
},breakOnThisError:function(error){if(this.hasErrorBreak(error)){Firebug..clearErrorBreakpoint(error.href,error.lineNo)
}else{Firebug..setErrorBreakpoint(error.href,error.lineNo)
...
Firebug..addDependentModule(this)
...
}Firebug..removeDependentModule(this);
...
if(FirebugContext&&!Firebug..isAlwaysEnabled()){menuItem.disabled=true
}return menuItem
...
Firebug..evaluate(scriptSource,context)
...
Firebug..addListener(this.Listener)
...
Firebug..removeListener(this.Listener)
}});
...
if(object instanceof jsdIStackFrame){return Firebug..evaluate(propName,this.context)
