...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            container.append($("<input type='hidden' name='" + id + "_filename' id='FileName'/>"));
            container.append($("<input type='hidden' name='" + id + "_guid' id='File_Guid'/>"));
            ...
            var defaults = {
                ...
                button_text: "<font face='Arial' size='13pt'>Browse</font>",
