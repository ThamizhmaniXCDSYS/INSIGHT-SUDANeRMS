    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <span class="ace-icon fa fa-caret-down icon-on-right"></span>';
                }
                else {
                    if (options.length > this.numberDisplayed) {
                        return options.length + ' ' + this.nSelectedText + ' <span class="ace-icon fa fa-caret-down icon-on-right"></span>';
                    }
                    else {
                        var selected = '';
                        ...
                        return selected.substr(0, selected.length - 2) + ' <span class="ace-icon fa fa-caret-down icon-on-right"></span>';
                    }
                }
            },
            /**
            ...
            buttonClass: 'btn btn-white btn-lg',
            dropRight: false,
            selectedClass: 'active',
            buttonWidth: 'auto',
            buttonContainer: '<div class="input-group input-group-sm">',
