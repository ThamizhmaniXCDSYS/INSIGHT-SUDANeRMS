...
{
    public class PSFForAnotherDatabase : IDisposable//, IExecuteStoredProcedure
    {
        #region Properties
        ...
        public PSFForAnotherDatabase(List<String> assemblyName,string connectionString)
        {

            //var _sessionFactory1 = new Configure().Load(ConfigurationManager.ConnectionStrings["SourceConnection"].ConnectionString, nhibernateProfiler).BuildSessionFactory();
            //ISession session1 = _sessionFactory1.OpenSession();
            ...
            try
            {
                ...
                lock (_syncObject)
                {
                    if (sessionFactory == null)
                    {
                        ...
                        #region Added by JP for adding another database
                        //code  for overridding the default connections
